...
Ecco una *ricevuta di prova* per mostrarti come funziona:`,
    ...
    domain: {
        ...
        members: {
            ...
            forceTwoFactorAuth: 'Forza l’autenticazione a due fattori',
            forceTwoFactorAuthSAMLEnabledDescription: `<muted-text>Disattiva <a href="${CONST.SAML_HELP_URL}">SAML</a> per imporre l'autenticazione a due fattori.</muted-text>`,
            forceTwoFactorAuthDescription: `<muted-text>Richiedi l’Autenticazione a Due Fattori per tutti i membri di questo dominio. Ai membri del dominio verrà richiesto di configurare l’Autenticazione a Due Fattori sul proprio account quando effettuano l’accesso.</muted-text>`,
            forceTwoFactorAuthError: "Non è stato possibile modificare l'imposizione dell'autenticazione a due fattori. Riprova più tardi.",
        },
