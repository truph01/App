...
(ad es. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    homePage: {
        ...
        forYouSection: {
            ...
            begin: 'Inizia',
            emptyStateMessages: {
                allCaughtUpTitle: 'Tutto a posto',
                niceWork: 'Bel lavoro!',
                yeehaw: 'Urrà!',
                youWin: 'Hai vinto!',
                allCaughtUpExclaim: 'Hai letto tutto!',
                bullseye: 'Centro!',
                allDone: 'Tutto fatto',
                allClean: 'Tutto a posto',
                takeItEasy: 'Prendila con calma',
                nothingToShow: 'Niente da mostrare',
                tasksCompleted: 'Attività completate',
                youreNumber1: 'Sei il numero 1!',
                kaZap: 'Ka-zap!',
                finished: 'Fatto!',
                keepAnEyeOut: "Tieni d'occhio le prossime novità!",
                allCaughtUpSubtitle: 'Hai letto tutto',
                timeForABreak: 'È ora di fare una pausa',
                timeToRelax: 'Ora è il momento di rilassarti',
                everythingsTidiedUp: 'Tutto è in ordine',
                caughtUpOnTasks: 'Hai completato tutti i tuoi task',
                upcomingTodos: 'Le prossime attività appariranno qui.',
                youreDone: 'Hai finito!',
                thumbsUpKeepEyeOut: 'Pollice in su per te, tieni d’occhio ciò che arriverà dopo.',
                todosWillLaunch: 'Le prossime attività da fare verranno visualizzate qui.',
                tasksWrangledKeepEyeOut: 'Tutte le attività sono sotto controllo, tieni d’occhio cosa arriverà dopo.',
                youDidItKeepEyeOut: 'Ce l’hai fatta! Tieni d’occhio quello che arriverà dopo.',
                relaxKeepEyeOut: 'È il momento di rilassarsi, ma tieni d’occhio ciò che arriverà dopo.',
                floatTodosHere: 'Ricontrolla più tardi e troverai qui le tue prossime cose da fare.',
                stayOnTargetKeepEyeOut: 'Ottimo, resti sulla giusta rotta. Tieni d’occhio cosa arriverà dopo!',
                relaxTodosHere: 'Vai a rilassarti, inseriremo qui le tue prossime cose da fare.',
                tasksCleanKeepEyeOut: 'Le attività sono a posto, ma tieni d’occhio quello che arriverà dopo.',
                todosAppearHome: 'Le prossime cose da fare appariranno qui nella tua home.',
                beepBoopKeepEyeOut: 'Beep boop beep boop, tieni d’occhio quello che sta per arrivare!',
                checkOffTodosHere: 'Spunta qui le tue prossime cose da fare.',
                zapTodosHere: 'Qui mostreremo le tue prossime cose da fare.',
                chillKeepEyeOut: 'È il momento di rilassarti, ma tieni d’occhio quello che arriverà dopo!',
                finishedKeepEyeOut: 'Hai finito per ora, ma resta in attesa di ciò che arriverà dopo.',
            },
        },
    },
    allSettingsScreen: {
