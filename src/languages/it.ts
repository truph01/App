...
Ecco una *ricevuta di prova* per mostrarti come funziona:`,
    ...
    domain: {
        ...
        samlLogin: {
            ...
            pleaseDisableTwoFactorAuth: 'Disattiva l’autenticazione a due fattori obbligatoria per abilitare l’accesso SAML.',
        },
        ...
        members: {
            ...
            forceTwoFactorAuthSAMLEnabledDescription: `<muted-text>Disabilita <a href="${CONST.SAML_HELP_URL}">SAML</a> per imporre l’autenticazione a due fattori.</muted-text>`,
            forceTwoFactorAuthDescription: `<muted-text>Richiedi l’Autenticazione a Due Fattori per tutti i membri di questo dominio. Ai membri del dominio verrà chiesto di configurare l’Autenticazione a Due Fattori sul proprio account al momento dell’accesso.</muted-text>`,
            forceTwoFactorAuthError: 'Imposibile modificare l’imposizione dell’autenticazione a due fattori. Riprova più tardi.',
        },
