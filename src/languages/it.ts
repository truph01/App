...
(ad es. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    homePage: {
        ...
        forYouSection: {
            ...
            begin: 'Inizia',
            emptyStateMessages: {
                allCaughtUpTitle: 'Tutto in pari',
                niceWork: 'Bel lavoro!',
                yeehaw: 'Yeehaw!',
                youWin: 'Hai vinto!',
                allCaughtUpExclaim: 'Tutto in pari!',
                bullseye: 'Centro!',
                allDone: 'Tutto fatto',
                allClean: 'Tutto pulito',
                ...
                allCaughtUpSubtitle: 'Sei in pari con tutto',
                timeForABreak: 'È ora di una pausa',
                timeToRelax: 'Adesso è il momento di rilassarsi',
                everythingsTidiedUp: 'Tutto è in ordine',
                caughtUpOnTasks: 'Sei in pari con le tue attività',
                upcomingTodos: 'Le prossime attività appariranno qui.',
                youreDone: 'Hai finito!',
                thumbsUpKeepEyeOut: "Pollice in su, tieni d'occhio le prossime novità.",
                todosWillLaunch: 'Le prossime attività partiranno da qui.',
                tasksWrangledKeepEyeOut: "Tutte le attività sono gestite, tieni d'occhio le prossime novità.",
                youDidItKeepEyeOut: "Ce l'hai fatta! Tieni d'occhio le prossime novità.",
                relaxKeepEyeOut: "È ora di rilassarsi, ma tieni d'occhio le prossime novità.",
                floatTodosHere: 'Torna più tardi, ti mostreremo le prossime attività qui.',
                stayOnTargetKeepEyeOut: "Perfettamente nel segno. Tieni d'occhio le prossime novità!",
                relaxTodosHere: 'Rilassati, metteremo le tue prossime attività qui.',
                tasksCleanKeepEyeOut: "Le attività sono in ordine, ma tieni d'occhio le prossime novità.",
                todosAppearHome: 'Le prossime attività appariranno qui nella tua home.',
                beepBoopKeepEyeOut: "Bip bop bip bop, tieni d'occhio le prossime novità!",
                checkOffTodosHere: 'Spunta le tue prossime attività qui.',
                zapTodosHere: 'Ti mostreremo le tue prossime attività qui in un lampo.',
                chillKeepEyeOut: "È ora di rilassarsi, ma tieni d'occhio le prossime novità!",
                finishedKeepEyeOut: "Hai finito per ora, ma tieni d'occhio le prossime novità.",
            },
        },
    },
    allSettingsScreen: {
