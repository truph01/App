    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                thumbsUpStar: 'Pollice in su per essere una vera star.',
                launchSomethingNew: 'È ora di lanciarsi in qualcosa di nuovo.',
                wrangledEveryTask: 'Hai gestito ogni singola attività.',
                thankTheAcademy: "È ora di ringraziare l'accademia.",
                hitTheBeach: 'È ora di andare in spiaggia.',
                cuteFish: 'Guarda questo pesciolino carino.',
                rightOnTarget: 'Tutto perfettamente nel segno.',
                takeASeat: 'È ora di sedersi.',
                niceAndTidy: 'Bello e ordinato. Super pulito. Wow.',
                welcomeHome: 'Bentornato a casa, te lo sei meritato.',
                beepBoop: 'Bip bop bip bop.',
                checkedEveryBox: 'Hai spuntato ogni casella.',
                shinyTrophy: 'Ecco un trofeo scintillante da parte nostra.',
                fastAsLightning: 'Veloce come un fulmine.',
                tooCool: 'Troppo cool per altre attività.',
                crossedFinishLine: 'Hai tagliato il traguardo.',
            },
        },
    },
    allSettingsScreen: {
