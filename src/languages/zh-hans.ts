...
（例如：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    multifactorAuthentication: {
        reviewTransaction: {
            ...
            pleaseReview: '请审核此交易',
            requiresYourReview: '一笔 Expensify Card 交易需要你在下方进行审核。',
            ...
            areYouSureToDeny: '你确定吗？如果你关闭此屏幕，此交易将会被拒绝。',
            youCanTryAgainAtMerchantOrReachOut: '您可以在商家处再试一次。如果您未发起此笔交易，请联系 Concierge 报告潜在欺诈。',
            youNeedToTryAgainAtMerchant: '此笔交易未通过验证，因此已被拒绝。您需要在商户处重新尝试。',
            goBackToTheMerchant: '返回商家网站继续完成交易。',
            authorizationFailed: '您的授权失败，因此我们拒绝了这笔交易。您可以在商家处再试一次。',
            attemptedTransaction: '尝试的交易',
        },
        biometricsTest: {
