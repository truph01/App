    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                youreDone: '你完成了！',
                thumbsUpStar: '为你这颗耀眼之星点赞。',
                launchSomethingNew: '是时候开始新的征程了。',
                wrangledEveryTask: '你搞定了每一个任务。',
                thankTheAcademy: '是时候感谢学院了。',
                hitTheBeach: '去海滩放松吧。',
                cuteFish: '看看这条可爱的小鱼。',
                rightOnTarget: '一切都正中目标。',
                takeASeat: '坐下来歇歇吧。',
                niceAndTidy: '干净整洁，超级清爽，哇。',
                welcomeHome: '欢迎回家，这是你应得的。',
                beepBoop: '哔哔嘟嘟。',
                checkedEveryBox: '你勾选了每一个选框。',
                shinyTrophy: '送你一座闪亮的奖杯。',
                fastAsLightning: '快如闪电。',
                tooCool: '酷到不需要更多任务。',
                crossedFinishLine: '你冲过了终点线。',
            },
        },
    },
    allSettingsScreen: {
