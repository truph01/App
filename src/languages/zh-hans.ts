...
（例如：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    twoFactorAuth: {
        ...
        explainProcessToRemove: '要停用双重身份验证（2FA），请输入身份验证应用中的有效验证码。',
...
这里有一张*测试收据*，来展示它是如何运作的：`,
    ...
    domain: {
        ...
        samlLogin: {
            ...
            pleaseDisableTwoFactorAuth: '请先禁用强制启用的双重身份验证以启用 SAML 登录。',
        },
        ...
        members: {
            ...
            forceTwoFactorAuthSAMLEnabledDescription: `<muted-text>请先禁用<a href="${CONST.SAML_HELP_URL}">SAML</a>，以强制启用双重身份验证。</muted-text>`,
            forceTwoFactorAuthDescription: `<muted-text>要求此域中的所有成员启用双重身份验证。域成员在登录其账户时将被提示设置双重身份验证。</muted-text>`,
            forceTwoFactorAuthError: '无法更改强制两步验证设置。请稍后重试。',
        },
        common: {settings: '设置'},
    },
};
