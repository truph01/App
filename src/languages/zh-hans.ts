...
（例如：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    homePage: {
        ...
        forYouSection: {
            ...
            begin: '开始',
            emptyStateMessages: {
                allCaughtUpTitle: '全部完成',
                niceWork: '干得好！',
                yeehaw: '耶哈！',
                youWin: '你赢了！',
                allCaughtUpExclaim: '全部处理完了！',
                bullseye: '正中靶心！',
                allDone: '全部完成',
                allClean: '全部清理完毕',
                takeItEasy: '放轻松',
                nothingToShow: '暂无内容展示',
                tasksCompleted: '已完成的任务',
                youreNumber1: '你是第一名！',
                kaZap: '咔——嚓！',
                finished: '完成！',
                keepAnEyeOut: '留意接下来会有什么新动态！',
                allCaughtUpSubtitle: '您已全部处理完毕',
                timeForABreak: '该休息一下了',
                timeToRelax: '现在是放松的时候了',
                everythingsTidiedUp: '一切都整理好了',
                caughtUpOnTasks: '您的任务都已完成',
                upcomingTodos: '即将到来的待办事项将显示在此处。',
                youreDone: '你已完成！',
                thumbsUpKeepEyeOut: '为你点赞，留意接下来要发生的事。',
                todosWillLaunch: '即将推出的待办事项会在此显示。',
                tasksWrangledKeepEyeOut: '所有任务都已处理完毕，请留意接下来的事项。',
                youDidItKeepEyeOut: '你成功了！请留意接下来会发生什么。',
                relaxKeepEyeOut: '是时候放松一下了，但也别忘了留意接下来会发生什么。',
                floatTodosHere: '稍后再来查看，我们会在这里显示你即将处理的待办事项。',
                stayOnTargetKeepEyeOut: '保持专注，继续期待接下来的精彩内容！',
                relaxTodosHere: '去放松一下吧，我们会把你即将要处理的待办事项放在这里。',
                tasksCleanKeepEyeOut: '任务暂时都已完成，但请留意接下来的事项。',
                todosAppearHome: '即将到来的待办事项会显示在你的主页中。',
                beepBoopKeepEyeOut: '哔哔啵啵，请留意接下来即将发生的事！',
                checkOffTodosHere: '在这里勾选完成你即将要做的事项。',
                zapTodosHere: '我们会在这里帮你清除接下来的待办事项。',
                chillKeepEyeOut: '是时候放松一下了，但也别忘了留意接下来要发生的事情！',
                finishedKeepEyeOut: '你目前已经完成了，但请留意接下来会发生什么。',
            },
        },
    },
    allSettingsScreen: {
