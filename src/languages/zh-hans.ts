...
（例如：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    homePage: {
        ...
        forYouSection: {
            ...
            begin: '开始',
            emptyStateMessages: {
                allCaughtUpTitle: '全部处理完毕',
                niceWork: '干得漂亮！',
                yeehaw: '耶哈！',
                youWin: '你赢了！',
                allCaughtUpExclaim: '全部处理完毕！',
                bullseye: '正中靶心！',
                allDone: '全部完成',
                allClean: '一干二净',
                takeItEasy: '放松一下',
                ...
                allCaughtUpSubtitle: '你已全部处理完毕',
                timeForABreak: '该休息一下了',
                timeToRelax: '现在是放松的时候了',
                everythingsTidiedUp: '一切都整理好了',
                caughtUpOnTasks: '你的任务都已处理完毕',
                upcomingTodos: '即将到来的待办事项将显示在此处。',
                youreDone: '你完成了！',
                thumbsUpKeepEyeOut: '为你点赞，留意接下来会有什么新动态。',
                todosWillLaunch: '即将到来的待办事项将在这里启动。',
                tasksWrangledKeepEyeOut: '所有任务都搞定了，留意接下来会有什么新动态。',
                youDidItKeepEyeOut: '你做到了！留意接下来会有什么新动态。',
                relaxKeepEyeOut: '放松一下吧，但要留意接下来会有什么新动态。',
                floatTodosHere: '稍后再来看看，我们会在这里展示你即将到来的待办事项。',
                stayOnTargetKeepEyeOut: '正中目标。留意接下来会有什么新动态！',
                relaxTodosHere: '放松一下，我们会把你的待办事项放在这里。',
                tasksCleanKeepEyeOut: '任务已清理完毕，但要留意接下来会有什么新动态。',
                todosAppearHome: '即将到来的待办事项将显示在你的主页上。',
                beepBoopKeepEyeOut: '哔哔嘟嘟，留意接下来会有什么新动态！',
                checkOffTodosHere: '在这里勾选你即将到来的待办事项。',
                zapTodosHere: '我们会在这里快速展示你的待办事项。',
                chillKeepEyeOut: '放松一下吧，但要留意接下来会有什么新动态！',
                finishedKeepEyeOut: '暂时完成了，但要留意接下来会有什么新动态。',
            },
        },
    },
    allSettingsScreen: {
