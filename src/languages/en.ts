...
import type {OriginalMessageSettlementAccountLocked, PolicyRulesModifiedFields, PersonalRulesModifiedFields} from '@src/types/onyx/OriginalMessage';
import type {
    AddBudgetParams,
...
const translations = {
    ...
    iou: {
        ...
        rulesModifiedFields: {
            ...
            reportName: (value: string) => `moved to report "${value}"`,
            ...
            format: (fragments: string, route: string, isPersonalRules: boolean) => `${fragments} via <a href="${route}">${isPersonalRules ? 'expense rules' : 'workspace rules'}</a>`,
        },
