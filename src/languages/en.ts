    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                thumbsUpKeepEyeOut: "Thumbs up to you, keep an eye out for what's coming next.",
                todosWillLaunch: 'Upcoming to-dos will launch here.',
                tasksWrangledKeepEyeOut: "All tasks are wrangled, keep an eye out for what's coming next.",
                youDidItKeepEyeOut: "You did it! Keep an eye out for what's coming next.",
                relaxKeepEyeOut: "Time to relax, but keep an eye out for what's coming next.",
                floatTodosHere: "Check back later and we'll float your upcoming to-dos here.",
                stayOnTargetKeepEyeOut: "Way to stay on target. Keep an eye out for what's coming next!",
                relaxTodosHere: "Go relax, we'll put your upcoming to-dos here.",
                tasksCleanKeepEyeOut: "Tasks are clean, but keep an eye out for what's coming next.",
                todosAppearHome: 'Upcoming to-dos will appear here in your home.',
                beepBoopKeepEyeOut: "Beep boop beep boop, keep an eye out for what's coming next!",
                checkOffTodosHere: 'Check off your upcoming to-dos here.',
                zapTodosHere: "We'll zap your upcoming to-dos here.",
                chillKeepEyeOut: "Time to chill, but keep an eye out for what's coming next!",
                finishedKeepEyeOut: "You're finished for now, but keep an eye out for what's coming next.", // cspell:disable-line
            },
        },
    },
    allSettingsScreen: {
