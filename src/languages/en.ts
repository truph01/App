    ...
    workspace: {
        ...
        moreFeatures: {
            ...
            companyCards: {
                ...
                unassign: 'Unassign',
                unassignCardDescription: "Unassigning this card will remove all associated transactions from the cardholder's draft reports.",
                assignCard: 'Assign card',
                removeCard: 'Remove card',
                remove: 'Remove',
                removeCardDescription: 'Removing this card will delete all associated transactions from your draft reports.',
