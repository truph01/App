...
(np. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    homePage: {
        ...
        forYouSection: {
            ...
            begin: 'Rozpocznij',
            emptyStateMessages: {
                allCaughtUpTitle: 'Wszystko nadrobione',
                niceWork: 'Dobra robota!',
                yeehaw: 'Juhuuu!',
                youWin: 'Wygrałeś!',
                allCaughtUpExclaim: 'Wszystko nadrobione!',
                bullseye: 'Trafiony!',
                allDone: 'Gotowe',
                allClean: 'Wszystko czyste',
                takeItEasy: 'Wyluzuj',
                nothingToShow: 'Nic do wyświetlenia',
                tasksCompleted: 'Zadania ukończone',
                youreNumber1: 'Jesteś numerem 1!',
                kaZap: 'Ka-zap!',
                finished: 'Zakończono!',
                keepAnEyeOut: 'Wypatruj tego, co nadchodzi!',
                allCaughtUpSubtitle: 'Wszystko nadrobione',
                timeForABreak: 'Czas na przerwę',
                timeToRelax: 'Czas się zrelaksować',
                everythingsTidiedUp: 'Wszystko posprzątane',
                caughtUpOnTasks: 'Masz już zrobione wszystkie zadania',
                upcomingTodos: 'Nadchodzące zadania pojawią się tutaj.',
                youreDone: 'Gotowe!',
                thumbsUpKeepEyeOut: 'Brawo dla ciebie, wypatruj tego, co nadchodzi.',
                todosWillLaunch: 'Nadchodzące zadania pojawią się tutaj.',
                tasksWrangledKeepEyeOut: 'Wszystkie zadania ogarnięte, wypatruj tego, co nadejdzie.',
                youDidItKeepEyeOut: 'Udało ci się! Wypatruj tego, co nadejdzie.',
                relaxKeepEyeOut: 'Czas na relaks, ale miej oko na to, co nadejdzie.',
                floatTodosHere: 'Wróć później, a wyświetlimy tu twoje nadchodzące zadania.',
                stayOnTargetKeepEyeOut: 'Świetnie trzymasz się celu. Wypatruj, co będzie dalej!',
                relaxTodosHere: 'Idź odpocząć, a my umieścimy tutaj twoje nadchodzące zadania.',
                tasksCleanKeepEyeOut: 'Zadania są ogarnięte, ale miej oko na to, co nadchodzi.',
                todosAppearHome: 'Nadchodzące zadania do wykonania pojawią się tutaj na ekranie głównym.',
                beepBoopKeepEyeOut: 'Bip bop bip bop, wypatruj, co nadchodzi dalej!',
                checkOffTodosHere: 'Odhaczaj tutaj swoje nadchodzące zadania.',
                zapTodosHere: 'Tutaj będziemy usuwać twoje nadchodzące zadania.',
                chillKeepEyeOut: 'Czas się zrelaksować, ale miej oko na to, co nadchodzi!',
                finishedKeepEyeOut: 'Na teraz wszystko gotowe, ale wypatruj, co nadchodzi dalej.',
            },
        },
    },
    allSettingsScreen: {
