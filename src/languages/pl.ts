    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                youreDone: 'Gotowe!',
                thumbsUpStar: 'Kciuk w górę za bycie prawdziwą gwiazdą.',
                launchSomethingNew: 'Czas rozpocząć coś nowego.',
                wrangledEveryTask: 'Uporałeś się z każdym zadaniem.',
                thankTheAcademy: 'Czas podziękować akademii.',
                hitTheBeach: 'Czas na plażę.',
                cuteFish: 'Spójrz na tę uroczą rybkę.',
                rightOnTarget: 'Wszystko prosto w cel.',
                takeASeat: 'Czas usiąść.',
                niceAndTidy: 'Ładnie i schludnie. Super czysto. Wow.',
                welcomeHome: 'Witaj w domu, zasłużyłeś na to.',
                beepBoop: 'Bip bop bip bop.',
                checkedEveryBox: 'Odhaczono każde pole.',
                shinyTrophy: 'Oto lśniące trofeum od nas.',
                fastAsLightning: 'Szybki jak błyskawica.',
                tooCool: 'Za cool na więcej zadań.',
                crossedFinishLine: 'Przekroczyłeś linię mety.',
            },
        },
    },
    allSettingsScreen: {
