    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                niceWork: 'Świetna robota!',
                yeehaw: 'Yeehaw!',
                youWin: 'Wygrywasz!',
                allCaughtUpExclaim: 'Wszystko na bieżąco!',
                bullseye: 'W dziesiątkę!',
                allDone: 'Wszystko zrobione',
                allClean: 'Czysto',
                takeItEasy: 'Spokojnie',
                ...
                allCaughtUpSubtitle: 'Jesteś na bieżąco',
                timeForABreak: 'Czas na przerwę',
                timeToRelax: 'Teraz czas na relaks',
                everythingsTidiedUp: 'Wszystko posprzątane',
                caughtUpOnTasks: 'Jesteś na bieżąco ze swoimi zadaniami',
                upcomingTodos: 'Nadchodzące zadania pojawią się tutaj.',
                youreDone: 'Gotowe!',
                thumbsUpKeepEyeOut: 'Kciuk w górę, wypatruj tego, co nadchodzi.',
                todosWillLaunch: 'Nadchodzące zadania wystartują tutaj.',
                tasksWrangledKeepEyeOut: 'Wszystkie zadania ogarnięte, wypatruj tego, co nadchodzi.',
                youDidItKeepEyeOut: 'Udało się! Wypatruj tego, co nadchodzi.',
                relaxKeepEyeOut: 'Czas na relaks, ale wypatruj tego, co nadchodzi.',
                floatTodosHere: 'Wróć później, pokażemy ci nadchodzące zadania tutaj.',
                stayOnTargetKeepEyeOut: 'Prosto w cel. Wypatruj tego, co nadchodzi!',
                relaxTodosHere: 'Odpoczywaj, postawimy twoje nadchodzące zadania tutaj.',
                tasksCleanKeepEyeOut: 'Zadania są czyste, ale wypatruj tego, co nadchodzi.',
                todosAppearHome: 'Nadchodzące zadania pojawią się tutaj na stronie głównej.',
                beepBoopKeepEyeOut: 'Bip bop bip bop, wypatruj tego, co nadchodzi!',
                checkOffTodosHere: 'Odhacz swoje nadchodzące zadania tutaj.',
                zapTodosHere: 'Pokażemy ci nadchodzące zadania tutaj błyskawicznie.',
                chillKeepEyeOut: 'Czas na chill, ale wypatruj tego, co nadchodzi!',
                finishedKeepEyeOut: 'Na razie gotowe, ale wypatruj tego, co nadchodzi.',
            },
        },
    },
    allSettingsScreen: {
