    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                yeehaw: '¡Yeehaw!',
                youWin: '¡Tú ganas!',
                allCaughtUpExclaim: '¡Todo al día!',
                bullseye: '¡Diana!',
                allDone: 'Todo listo',
                allClean: 'Todo limpio',
                takeItEasy: 'Tómatelo con calma',
                nothingToShow: 'Nada que mostrar',
                tasksCompleted: 'Tareas completadas',
                youreNumber1: '¡Eres el número 1!',
                kaZap: '¡Ka-zap!',
                finished: '¡Terminado!',
                keepAnEyeOut: '¡Mantente atento a lo que viene!',
                allCaughtUpSubtitle: 'Estás al día',
                timeForABreak: 'Hora de un descanso',
                timeToRelax: 'Ahora es hora de relajarse',
                everythingsTidiedUp: 'Todo está ordenado',
                caughtUpOnTasks: 'Estás al día con tus tareas',
                upcomingTodos: 'Las próximas tareas aparecerán aquí.',
                youreDone: '¡Has terminado!',
                thumbsUpKeepEyeOut: 'Pulgar arriba, mantente atento a lo que viene.',
                todosWillLaunch: 'Las próximas tareas se lanzarán aquí.',
                tasksWrangledKeepEyeOut: 'Todas las tareas están domadas, mantente atento a lo que viene.',
                youDidItKeepEyeOut: '¡Lo lograste! Mantente atento a lo que viene.',
                relaxKeepEyeOut: 'Hora de relajarse, pero mantente atento a lo que viene.',
                floatTodosHere: 'Vuelve más tarde y te mostraremos tus próximas tareas aquí.',
                stayOnTargetKeepEyeOut: 'Justo en el blanco. ¡Mantente atento a lo que viene!',
                relaxTodosHere: 'Relájate, pondremos tus próximas tareas aquí.',
                tasksCleanKeepEyeOut: 'Las tareas están limpias, pero mantente atento a lo que viene.',
                todosAppearHome: 'Las próximas tareas aparecerán aquí en tu inicio.',
                beepBoopKeepEyeOut: '¡Bip bup bip bup, mantente atento a lo que viene!',
                checkOffTodosHere: 'Marca tus próximas tareas aquí.',
                zapTodosHere: 'Te mostraremos tus próximas tareas aquí.',
                chillKeepEyeOut: '¡Hora de relajarse, pero mantente atento a lo que viene!',
                finishedKeepEyeOut: 'Has terminado por ahora, pero mantente atento a lo que viene.',
            },
        },
    },
    allSettingsScreen: {
