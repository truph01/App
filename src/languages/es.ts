    ...
    report: {
        ...
        actions: {
            type: {
                ...
                actionableCard3DSTransactionApproval: (amount: string, merchant: string) => `Abra la aplicación móvil de Expensify para revisar su transacción de ${amount} ${merchant}`,
