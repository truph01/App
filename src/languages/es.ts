    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                thumbsUpStar: 'Pulgar arriba por ser una estrella total.',
                launchSomethingNew: 'Hora de lanzarse a algo nuevo.',
                wrangledEveryTask: 'Domaste cada última tarea.',
                thankTheAcademy: 'Hora de agradecer a la academia.',
                hitTheBeach: 'Hora de ir a la playa.',
                cuteFish: 'Mira este pececito lindo.',
                rightOnTarget: 'Todo está justo en el blanco.',
                takeASeat: 'Hora de tomar asiento.',
                niceAndTidy: 'Limpio y ordenado. Súper limpio. Wow.',
                welcomeHome: 'Bienvenido a casa, te lo ganaste.',
                beepBoop: 'Bip bup bip bup.',
                checkedEveryBox: 'Marcaste cada casilla.',
                shinyTrophy: 'Aquí tienes un trofeo brillante de nuestra parte.',
                fastAsLightning: 'Rápido como un rayo.',
                tooCool: 'Demasiado genial para más tareas.',
                crossedFinishLine: 'Cruzaste la línea de meta.',
            },
        },
    },
    allSettingsScreen: {
