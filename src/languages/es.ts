...
${amount} para ${merchant} - ${date}`,
    ...
    domain: {
        ...
        members: {
            ...
            forceTwoFactorAuthSAMLEnabledDescription: (samlPageUrl: string) => `<muted-text>Por favor, deshabilita <a href="${samlPageUrl}">SAML</a> para forzar la autenticación de dos factores.</muted-text>`,
