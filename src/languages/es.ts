    ...
    domain: {
        ...
        samlLogin: {
            ...
            pleaseDisableTwoFactorAuth: (twoFactorAuthSettingsUrl: string) =>
                `<muted-text>Por favor, deshabilita la <a href="${twoFactorAuthSettingsUrl}">autenticación de dos factores obligatoria</a> para habilitar el inicio de sesión con SAML.</muted-text>`,
        },
