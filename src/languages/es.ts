    ...
    workspace: {
        ...
        moreFeatures: {
            ...
            companyCards: {
                ...
                unassign: 'Desasignar',
                unassignCardDescription: 'Desasignar esta tarjeta eliminará todas las transacciones asociadas a los informes en borrador del titular de la tarjeta.',
                removeCard: 'Eliminar tarjeta',
                remove: 'Eliminar',
                removeCardDescription: 'Eliminar esta tarjeta borrará todas las transacciones asociadas a tus informes en borrador.',
                assignCard: 'Asignar tarjeta',
