    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                yeehaw: 'Iupi!',
                youWin: 'Você venceu!',
                allCaughtUpExclaim: 'Tudo em dia!',
                bullseye: 'Na mosca!',
                allDone: 'Tudo pronto',
                allClean: 'Tudo limpo',
                takeItEasy: 'Vá com calma',
                nothingToShow: 'Nada para mostrar',
                tasksCompleted: 'Tarefas concluídas',
                youreNumber1: 'Você é o número 1!',
                kaZap: 'Ka-zap!',
                finished: 'Concluído!',
                keepAnEyeOut: 'Fique de olho no que vem por aí!',
                allCaughtUpSubtitle: 'Você está em dia',
                timeForABreak: 'Hora de uma pausa',
                timeToRelax: 'Agora é hora de relaxar',
                everythingsTidiedUp: 'Tudo organizado',
                caughtUpOnTasks: 'Você está em dia com as suas tarefas',
                upcomingTodos: 'As próximas tarefas aparecerão aqui.',
                youreDone: 'Você terminou!',
                thumbsUpKeepEyeOut: 'Parabéns para você, fique de olho no que vem por aí.',
                todosWillLaunch: 'As próximas tarefas pendentes serão exibidas aqui.',
                tasksWrangledKeepEyeOut: 'Todas as tarefas estão controladas, fique de olho no que vem a seguir.',
                youDidItKeepEyeOut: 'Você conseguiu! Fique de olho no que vem por aí.',
                relaxKeepEyeOut: 'Hora de relaxar, mas fique de olho no que vem por aí.',
                floatTodosHere: 'Volte mais tarde e nós vamos mostrar aqui as suas próximas tarefas.',
                stayOnTargetKeepEyeOut: 'Boa, você está mantendo o foco. Fique de olho no que vem por aí!',
                relaxTodosHere: 'Vá relaxar, nós colocaremos suas próximas tarefas aqui.',
                tasksCleanKeepEyeOut: 'As tarefas estão em dia, mas fique de olho no que vem a seguir.',
                todosAppearHome: 'As próximas tarefas aparecerão aqui na sua tela inicial.',
                beepBoopKeepEyeOut: 'Bi bi bi bi, fique de olho no que vem por aí!',
                checkOffTodosHere: 'Marque aqui suas próximas tarefas pendentes.',
                zapTodosHere: 'Vamos acabar com suas próximas tarefas aqui.',
                chillKeepEyeOut: 'Hora de relaxar, mas fique de olho no que vem por aí!',
                finishedKeepEyeOut: 'Você terminou por enquanto, mas fique de olho no que vem a seguir.',
            },
        },
    },
    allSettingsScreen: {
