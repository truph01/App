    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                everythingsTidiedUp: 'Tudo arrumado',
                caughtUpOnTasks: 'Você está em dia com suas tarefas',
                upcomingTodos: 'As próximas tarefas aparecerão aqui.',
                youreDone: 'Você terminou!',
                thumbsUpKeepEyeOut: 'Joinha para você, fique de olho no que vem por aí.',
                todosWillLaunch: 'As próximas tarefas serão lançadas aqui.',
                tasksWrangledKeepEyeOut: 'Todas as tarefas estão resolvidas, fique de olho no que vem por aí.',
                ...
                floatTodosHere: 'Volte mais tarde, vamos mostrar suas próximas tarefas aqui.',
                stayOnTargetKeepEyeOut: 'Certinho no alvo. Fique de olho no que vem por aí!',
                relaxTodosHere: 'Relaxa, vamos colocar suas próximas tarefas aqui.',
                tasksCleanKeepEyeOut: 'Tarefas limpas, mas fique de olho no que vem por aí.',
                todosAppearHome: 'As próximas tarefas aparecerão aqui na sua página inicial.',
                beepBoopKeepEyeOut: 'Bip bop bip bop, fique de olho no que vem por aí!',
                checkOffTodosHere: 'Marque suas próximas tarefas aqui.',
                zapTodosHere: 'Vamos mostrar suas próximas tarefas aqui num zás.',
                chillKeepEyeOut: 'Hora de relaxar, mas fique de olho no que vem por aí!',
                finishedKeepEyeOut: 'Você terminou por enquanto, mas fique de olho no que vem por aí.',
            },
        },
    },
    allSettingsScreen: {
