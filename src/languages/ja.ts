    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                youreDone: '完了です！',
                thumbsUpStar: 'スターなあなたにグッド。',
                launchSomethingNew: '新しいことを始める時間です。',
                wrangledEveryTask: 'すべてのタスクを片付けました。',
                thankTheAcademy: 'アカデミーに感謝する時間です。',
                hitTheBeach: 'ビーチに行く時間です。',
                cuteFish: 'このかわいいお魚を見て。',
                rightOnTarget: 'すべてが的中です。',
                takeASeat: '座ってひと休みしましょう。',
                niceAndTidy: 'きれいに整頓。すっきり。すごい。',
                welcomeHome: 'おかえりなさい、お疲れさまでした。',
                beepBoop: 'ピピッポッピピッポッ。',
                checkedEveryBox: 'すべてのチェックを完了しました。',
                shinyTrophy: 'ピカピカのトロフィーをどうぞ。',
                fastAsLightning: '稲妻のように速い。',
                tooCool: 'タスクなんてお手のもの。',
                crossedFinishLine: 'ゴールラインを突破しました。',
            },
        },
    },
    allSettingsScreen: {
