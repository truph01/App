...
（例：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    homePage: {
        ...
        forYouSection: {
            ...
            begin: '開始',
            emptyStateMessages: {
                allCaughtUpTitle: 'すべて確認済みです',
                niceWork: 'よくできました！',
                yeehaw: 'やったー！',
                youWin: 'あなたの勝ちです！',
                allCaughtUpExclaim: 'すべて確認済みです！',
                bullseye: 'どんぴしゃ！',
                allDone: '完了しました',
                allClean: 'すべてクリアしました',
                takeItEasy: '気楽にいきましょう',
                nothingToShow: '表示するものがありません',
                tasksCompleted: '完了したタスク',
                youreNumber1: 'あなたはナンバーワンです！',
                kaZap: 'カ・ザップ！',
                finished: '完了しました！',
                keepAnEyeOut: '次に届くものをお楽しみに！',
                allCaughtUpSubtitle: '最新の状態です',
                timeForABreak: '休憩の時間です',
                timeToRelax: 'さあ、くつろぐ時間です',
                everythingsTidiedUp: 'すべて整理されました',
                caughtUpOnTasks: 'すべてのタスクが完了しました',
                upcomingTodos: '今後のやることがここに表示されます。',
                youreDone: '完了しました！',
                thumbsUpKeepEyeOut: 'この調子です！次に何が起こるか注目していてください。',
                todosWillLaunch: '今後の To-do がここに表示されます。',
                tasksWrangledKeepEyeOut: 'すべてのタスクが片付きました。次に来るものにご注目ください。',
                youDidItKeepEyeOut: 'やりました！このあとに続く内容にご注目ください。',
                relaxKeepEyeOut: 'ひと息つく時間ですが、このあとに続くことにもご注目ください。',
                floatTodosHere: '後でまた確認してください。今後のやるべきことがここに表示されます。',
                stayOnTargetKeepEyeOut: '目標どおりですね。次に何が起こるか、引き続き注目していてください！',
                relaxTodosHere: 'ゆっくりおくつろぎください。今後のやることリストはこちらに表示します。',
                tasksCleanKeepEyeOut: 'タスクは順調ですが、このあとに控えていることにも注意しておきましょう。',
                todosAppearHome: '今後のやることが、このホーム画面に表示されます。',
                beepBoopKeepEyeOut: 'ピッピッ、ブッブッ。次に何が起こるか、お見逃しなく！',
                checkOffTodosHere: 'ここで今後のやることにチェックを付けましょう。',
                zapTodosHere: '今後のあなたの ToDo をここでサッと片付けます。',
                chillKeepEyeOut: 'ひと休みするときですが、このあとに続くことにもご注目ください！',
                finishedKeepEyeOut: 'ひとまず完了しましたが、今後追加される内容にご注目ください。',
            },
        },
    },
    allSettingsScreen: {
