...
使い方がわかるように、こちらが*テスト用レシート*です。`,
    ...
    domain: {
        ...
        samlLogin: {
            ...
            pleaseDisableTwoFactorAuth: 'SAML ログインを有効にするには、必須の 2 要素認証を無効にしてください。',
        },
        ...
        members: {
            ...
            forceTwoFactorAuth: '二要素認証を必須にする',
            forceTwoFactorAuthSAMLEnabledDescription: `<muted-text>2 要素認証を必須にするには、<a href="${CONST.SAML_HELP_URL}">SAML</a> を無効にしてください。</muted-text>`,
