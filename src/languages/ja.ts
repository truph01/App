...
（例：${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER}）`,
    ...
    homePage: {
        ...
        forYouSection: {
            ...
            begin: '開始',
            emptyStateMessages: {
                allCaughtUpTitle: 'すべて完了',
                niceWork: 'お見事！',
                yeehaw: 'イェーハー！',
                youWin: 'あなたの勝ち！',
                allCaughtUpExclaim: 'すべて完了！',
                bullseye: '的中！',
                allDone: 'すべて完了',
                allClean: 'すっきり',
                takeItEasy: 'のんびりしよう',
                nothingToShow: '表示するものはありません',
                tasksCompleted: 'タスク完了',
                youreNumber1: 'あなたがナンバーワン！',
                kaZap: 'カザップ！',
                finished: '完了！',
                keepAnEyeOut: '次に届くものをお楽しみに！',
                allCaughtUpSubtitle: 'すべて対応済みです',
                timeForABreak: '休憩の時間',
                timeToRelax: 'リラックスする時間です',
                everythingsTidiedUp: 'すべて片付きました',
                caughtUpOnTasks: 'タスクはすべて対応済みです',
                upcomingTodos: '今後のやることがここに表示されます。',
                youreDone: '完了です！',
                thumbsUpKeepEyeOut: 'グッド、次に届くものをお楽しみに。',
                todosWillLaunch: '今後のやることがここから始まります。',
                tasksWrangledKeepEyeOut: 'すべてのタスクを片付けました。次に届くものをお楽しみに。',
                youDidItKeepEyeOut: 'やりました！次に届くものをお楽しみに。',
                relaxKeepEyeOut: 'リラックスする時間ですが、次に届くものをお楽しみに。',
                floatTodosHere: 'また後で確認してください。今後のやることをここに表示します。',
                stayOnTargetKeepEyeOut: '的中です。次に届くものをお楽しみに！',
                relaxTodosHere: 'リラックスしてください。今後のやることをここに表示します。',
                tasksCleanKeepEyeOut: 'タスクはすっきり。でも次に届くものをお楽しみに。',
                todosAppearHome: '今後のやることがここのホームに表示されます。',
                beepBoopKeepEyeOut: 'ピピッポッピピッポッ、次に届くものをお楽しみに！',
                checkOffTodosHere: '今後のやることをここでチェックしましょう。',
                zapTodosHere: '今後のやることをここにすばやく表示します。',
                chillKeepEyeOut: 'のんびりする時間ですが、次に届くものをお楽しみに！',
                finishedKeepEyeOut: '今は完了ですが、次に届くものをお楽しみに。',
            },
        },
    },
    allSettingsScreen: {
