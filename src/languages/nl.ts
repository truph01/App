...
(bijv. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    twoFactorAuth: {
        ...
        explainProcessToRemoveWithRecovery: 'Voer een geldige herstelsleutel in om twee-factor-authenticatie (2FA) uit te schakelen.',
...
Hier is een *proefbon* om je te laten zien hoe het werkt:`,
    ...
    domain: {
        ...
        samlLogin: {
            ...
            pleaseDisableTwoFactorAuth: 'Schakel verplichte twee-factor-authenticatie uit om SAML-aanmelding mogelijk te maken.',
        },
        ...
        members: {
            ...
            forceTwoFactorAuth: 'Tweestapsverificatie afdwingen',
            forceTwoFactorAuthSAMLEnabledDescription: `<muted-text>Schakel <a href="${CONST.SAML_HELP_URL}">SAML</a> uit om tweestapsverificatie af te dwingen.</muted-text>`,
            forceTwoFactorAuthDescription: `<muted-text>Tweeledige verificatie vereisen voor alle leden van dit domein. Domeinleden wordt gevraagd tweefactorauthenticatie voor hun account in te stellen wanneer ze zich aanmelden.</muted-text>`,
