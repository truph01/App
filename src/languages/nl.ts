...
(bijv. ${CONST.FORMATTED_EXAMPLE_PHONE_NUMBER})`,
    ...
    homePage: {
        ...
        forYouSection: {
            ...
            begin: 'Begin',
            emptyStateMessages: {
                allCaughtUpTitle: 'Helemaal bij',
                niceWork: 'Goed gedaan!',
                yeehaw: 'Jeej!',
                youWin: 'Je hebt gewonnen!',
                allCaughtUpExclaim: 'Je bent helemaal bij!',
                bullseye: 'Roos!',
                allDone: 'Helemaal klaar',
                allClean: 'Helemaal schoon',
                takeItEasy: 'Doe rustig aan',
                nothingToShow: 'Niets om weer te geven',
                tasksCompleted: 'Taken voltooid',
                youreNumber1: 'Je bent nummer 1!',
                kaZap: 'Ka-zap!',
                finished: 'Klaar!',
                keepAnEyeOut: 'Houd in de gaten wat er nog aankomt!',
                allCaughtUpSubtitle: 'Je bent helemaal bij',
                timeForABreak: 'Tijd voor een pauze',
                timeToRelax: 'Nu is het tijd om te ontspannen',
                everythingsTidiedUp: 'Alles is opgeruimd',
                caughtUpOnTasks: 'Je bent helemaal bij met je taken',
                upcomingTodos: 'Aankomende taken verschijnen hier.',
                youreDone: 'Je bent klaar!',
                thumbsUpKeepEyeOut: 'Duim omhoog voor jou, houd in de gaten wat er hierna komt.',
                todosWillLaunch: 'Aankomende taken verschijnen hier.',
                tasksWrangledKeepEyeOut: 'Alle taken zijn geregeld, houd in de gaten wat er hierna komt.',
                youDidItKeepEyeOut: 'Je hebt het gedaan! Houd in de gaten wat er hierna komt.',
                relaxKeepEyeOut: 'Tijd om te ontspannen, maar houd in de gaten wat er hierna komt.',
                floatTodosHere: 'Kom later terug, dan laten we je komende taken hier zien.',
                stayOnTargetKeepEyeOut: 'Goed bezig, je blijft op koers. Houd in de gaten wat er hierna komt!',
                relaxTodosHere: "Ga maar ontspannen, we zetten je aankomende to-do's hier neer.",
                tasksCleanKeepEyeOut: 'Taken zijn afgerond, maar houd in de gaten wat er hierna komt.',
                todosAppearHome: 'Je aankomende taken verschijnen hier op je startpagina.',
                beepBoopKeepEyeOut: 'Biep boep biep boep, houd in de gaten wat er hierna komt!',
                checkOffTodosHere: 'Vink hier je komende taken af.',
                zapTodosHere: 'We laten je komende taken hier verdwijnen.',
                chillKeepEyeOut: 'Tijd om te relaxen, maar houd in de gaten wat er hierna komt!',
                finishedKeepEyeOut: 'Je bent voorlopig klaar, maar houd in de gaten wat er hierna komt.',
            },
        },
    },
    allSettingsScreen: {
