    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                thumbsUpStar: 'Duim omhoog – je bent een echte ster.',
                launchSomethingNew: 'Tijd om iets nieuws te beginnen.',
                wrangledEveryTask: 'Je hebt elke taak afgerond.',
                thankTheAcademy: 'Tijd om de academie te bedanken.',
                hitTheBeach: 'Tijd om naar het strand te gaan.',
                cuteFish: 'Kijk naar dit schattige visje.',
                rightOnTarget: 'Alles recht in de roos.',
                takeASeat: 'Tijd om even te zitten.',
                niceAndTidy: 'Netjes en opgeruimd. Superschoon. Wow.',
                welcomeHome: 'Welkom thuis, je hebt het verdiend.',
                beepBoop: 'Piep poep piep poep.',
                checkedEveryBox: 'Je hebt elk vakje aangevinkt.',
                shinyTrophy: 'Hier is een glimmende trofee van ons.',
                fastAsLightning: 'Snel als de bliksem.',
                tooCool: 'Te cool voor meer taken.',
                crossedFinishLine: 'Je hebt de finish gehaald.',
            },
        },
    },
    allSettingsScreen: {
