    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                allCaughtUpExclaim: 'Alles erledigt!',
                bullseye: 'Treffer!',
                allDone: 'Alles erledigt',
                allClean: 'Alles sauber',
                takeItEasy: 'Ganz ruhig bleiben',
                nothingToShow: 'Nichts anzuzeigen',
                tasksCompleted: 'Aufgaben abgeschlossen',
                youreNumber1: 'Sie sind die Nummer 1!',
                kaZap: 'Ka-zapp!',
                finished: 'Fertig!',
                keepAnEyeOut: 'Halte Ausschau nach dem, was als Nächstes kommt!',
                allCaughtUpSubtitle: 'Sie sind auf dem neuesten Stand',
                timeForABreak: 'Zeit für eine Pause',
                timeToRelax: 'Jetzt ist es Zeit, sich zu entspannen',
                everythingsTidiedUp: 'Alles ist aufgeräumt',
                caughtUpOnTasks: 'Sie sind mit all Ihren Aufgaben auf dem neuesten Stand',
                upcomingTodos: 'Anstehende Aufgaben erscheinen hier.',
                youreDone: 'Sie sind fertig!',
                thumbsUpKeepEyeOut: 'Daumen hoch für Sie, bleiben Sie gespannt auf das, was als Nächstes kommt.',
                todosWillLaunch: 'Anstehende To-dos werden hier angezeigt.',
                tasksWrangledKeepEyeOut: 'Alle Aufgaben sind erledigt, behalten Sie im Blick, was als Nächstes kommt.',
                youDidItKeepEyeOut: 'Geschafft! Behalten Sie im Blick, was als Nächstes kommt.',
                relaxKeepEyeOut: 'Zeit zum Entspannen, aber behalten Sie im Blick, was als Nächstes kommt.',
                floatTodosHere: 'Schauen Sie später noch einmal vorbei, dann zeigen wir Ihnen hier Ihre anstehenden To-dos.',
                stayOnTargetKeepEyeOut: 'Weiter so, Sie bleiben auf Kurs. Halten Sie Ausschau nach dem, was als Nächstes kommt!',
                relaxTodosHere: 'Entspannen Sie sich, wir fügen Ihre kommenden Aufgaben hier ein.',
                tasksCleanKeepEyeOut: 'Aufgaben sind erledigt, aber behalten Sie im Blick, was als Nächstes kommt.',
                todosAppearHome: 'Anstehende Aufgaben werden hier in Ihrem Startbereich angezeigt.',
                beepBoopKeepEyeOut: 'Biep biep biep biep, halten Sie die Augen offen für das, was als Nächstes kommt!',
                checkOffTodosHere: 'Haken Sie hier Ihre anstehenden Aufgaben ab.',
                zapTodosHere: 'Wir erledigen Ihre anstehenden Aufgaben hier.',
                chillKeepEyeOut: 'Zeit zum Entspannen, aber behalten Sie im Blick, was als Nächstes kommt!',
                finishedKeepEyeOut: 'Sie sind vorerst fertig, aber behalten Sie im Blick, was als Nächstes kommt.',
            },
        },
    },
    allSettingsScreen: {
