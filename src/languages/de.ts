    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                thumbsUpStar: 'Daumen hoch – du bist ein echter Star.',
                launchSomethingNew: 'Zeit, etwas Neues zu starten.',
                wrangledEveryTask: 'Du hast jede einzelne Aufgabe erledigt.',
                thankTheAcademy: 'Zeit, sich bei der Akademie zu bedanken.',
                hitTheBeach: 'Ab an den Strand.',
                cuteFish: 'Schau dir diesen süßen Fisch an.',
                rightOnTarget: 'Alles genau im Ziel.',
                takeASeat: 'Zeit, sich hinzusetzen.',
                niceAndTidy: 'Schön und ordentlich. Super sauber. Wow.',
                welcomeHome: 'Willkommen zu Hause, du hast es dir verdient.',
                beepBoop: 'Piep piep piep piep.',
                checkedEveryBox: 'Du hast jedes Kästchen abgehakt.',
                shinyTrophy: 'Hier ist eine glänzende Trophäe von uns.',
                fastAsLightning: 'Schnell wie der Blitz.',
                tooCool: 'Zu cool für mehr Aufgaben.',
                crossedFinishLine: 'Du hast die Ziellinie überquert.',
            },
        },
    },
    allSettingsScreen: {
