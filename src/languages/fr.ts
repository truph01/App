    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                thumbsUpStar: "Pouce en l'air pour cette performance de star.",
                launchSomethingNew: "C'est le moment de se lancer dans quelque chose de nouveau.",
                wrangledEveryTask: 'Tu as maîtrisé chaque tâche.',
                thankTheAcademy: "C'est le moment de remercier l'académie.",
                hitTheBeach: 'Direction la plage.',
                cuteFish: 'Regarde ce joli poisson.',
                rightOnTarget: 'Tout est parfaitement dans la cible.',
                takeASeat: "C'est le moment de s'asseoir.",
                niceAndTidy: 'Propre et rangé. Super clean. Wow.',
                welcomeHome: "Bienvenue à la maison, tu l'as bien mérité.",
                beepBoop: 'Bip boup bip boup.',
                checkedEveryBox: 'Tu as coché chaque case.',
                shinyTrophy: 'Voici un trophée brillant de notre part.',
                fastAsLightning: "Rapide comme l'éclair.",
                tooCool: 'Trop cool pour plus de tâches.',
                crossedFinishLine: "Tu as franchi la ligne d'arrivée.",
            },
        },
    },
    allSettingsScreen: {
