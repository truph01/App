    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                allCaughtUpExclaim: 'Vous êtes à jour !',
                bullseye: 'En plein dans le mille !',
                allDone: 'Terminé',
                allClean: 'Tout est propre',
                takeItEasy: 'Du calme',
                nothingToShow: 'Rien à afficher',
                tasksCompleted: 'Tâches terminées',
                youreNumber1: 'Vous êtes numéro 1 !',
                kaZap: 'Ka-zap !',
                finished: 'Terminé !',
                keepAnEyeOut: "Reste à l'affût de ce qui arrive !",
                allCaughtUpSubtitle: 'Vous êtes à jour',
                timeForABreak: 'C’est l’heure d’une pause',
                timeToRelax: 'Il est maintenant temps de se détendre',
                everythingsTidiedUp: 'Tout est rangé',
                caughtUpOnTasks: 'Vous êtes à jour dans vos tâches',
                upcomingTodos: 'Les prochaines tâches apparaîtront ici.',
                youreDone: 'C’est terminé !',
                thumbsUpKeepEyeOut: 'Un grand bravo à vous, restez à l’affût de ce qui arrive ensuite.',
                todosWillLaunch: 'Les prochaines tâches à faire apparaîtront ici.',
                tasksWrangledKeepEyeOut: 'Toutes les tâches sont maîtrisées, gardez un œil sur ce qui arrive ensuite.',
                youDidItKeepEyeOut: 'Vous y êtes arrivé ! Restez attentif à ce qui va suivre.',
                relaxKeepEyeOut: 'Il est temps de se détendre, mais gardez un œil sur ce qui arrive ensuite.',
                floatTodosHere: 'Revenez plus tard et nous ferons apparaître vos prochaines tâches à faire ici.',
                stayOnTargetKeepEyeOut: 'Bravo, vous restez dans la bonne direction. Gardez un œil sur ce qui arrive ensuite !',
                relaxTodosHere: 'Allez vous détendre, nous placerons ici vos prochaines tâches à faire.',
                tasksCleanKeepEyeOut: 'Les tâches sont terminées, mais gardez un œil sur ce qui arrive ensuite.',
                todosAppearHome: 'Les tâches à venir apparaîtront ici sur votre page d’accueil.',
                beepBoopKeepEyeOut: 'Bip bop bip bop, gardez un œil ouvert sur ce qui arrive ensuite !',
                checkOffTodosHere: 'Cochez vos prochaines tâches à faire ici.',
                zapTodosHere: 'Nous traiterons vos prochaines tâches à faire ici.',
                chillKeepEyeOut: 'Temps de se détendre, mais gardez un œil sur ce qui arrive ensuite !',
                finishedKeepEyeOut: 'Vous avez terminé pour l’instant, mais restez à l’affût de ce qui arrive ensuite.',
            },
        },
    },
    allSettingsScreen: {
