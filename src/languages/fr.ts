    ...
    homePage: {
        ...
        forYouSection: {
            ...
            emptyStateMessages: {
                ...
                yeehaw: 'Yeehaw !',
                youWin: 'Tu as gagné !',
                allCaughtUpExclaim: 'Tout est à jour !',
                bullseye: 'Dans le mille !',
                allDone: 'Tout est fait',
                allClean: 'Tout est propre',
                takeItEasy: 'Détends-toi',
                nothingToShow: 'Rien à afficher',
                tasksCompleted: 'Tâches terminées',
                youreNumber1: 'Tu es le numéro 1 !',
                kaZap: 'Ka-zap !',
                finished: 'Terminé !',
                keepAnEyeOut: "Reste à l'affût de ce qui arrive !",
                allCaughtUpSubtitle: 'Tu es à jour',
                timeForABreak: "C'est l'heure de la pause",
                timeToRelax: "Maintenant c'est le moment de se détendre",
                everythingsTidiedUp: 'Tout est rangé',
                caughtUpOnTasks: 'Tu es à jour sur toutes tes tâches',
                upcomingTodos: 'Les prochaines tâches apparaîtront ici.',
                youreDone: "C'est terminé !",
                thumbsUpKeepEyeOut: "Pouce en l'air, reste à l'affût de ce qui arrive.",
                todosWillLaunch: 'Les prochaines tâches se lanceront ici.',
                tasksWrangledKeepEyeOut: "Toutes les tâches sont maîtrisées, reste à l'affût de ce qui arrive.",
                youDidItKeepEyeOut: "Tu as réussi ! Reste à l'affût de ce qui arrive.",
                relaxKeepEyeOut: "C'est le moment de se détendre, mais reste à l'affût de ce qui arrive.",
                floatTodosHere: 'Reviens plus tard, on affichera tes prochaines tâches ici.',
                stayOnTargetKeepEyeOut: "Parfaitement dans la cible. Reste à l'affût de ce qui arrive !",
                relaxTodosHere: 'Détends-toi, on mettra tes prochaines tâches ici.',
                tasksCleanKeepEyeOut: "Les tâches sont propres, mais reste à l'affût de ce qui arrive.",
                todosAppearHome: 'Les prochaines tâches apparaîtront ici dans ton accueil.',
                beepBoopKeepEyeOut: "Bip boup bip boup, reste à l'affût de ce qui arrive !",
                checkOffTodosHere: 'Coche tes prochaines tâches ici.',
                zapTodosHere: 'On affichera tes prochaines tâches ici en un éclair.',
                chillKeepEyeOut: "C'est le moment de se détendre, mais reste à l'affût de ce qui arrive !",
                finishedKeepEyeOut: "Tu as terminé pour l'instant, mais reste à l'affût de ce qui arrive.",
            },
        },
    },
    allSettingsScreen: {
