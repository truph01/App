...
function ConsolePage() {
    const icons = useMemoizedLazyExpensifyIcons(['All', 'CheckCircle', 'Checkmark', 'Download', 'Filter', 'Globe', 'UploadAlt'] as const);
    ...
    const menuItems: PopoverMenuItem[] = useMemo(
        ...
        [activeFilterIndex, icons.All, icons.CheckCircle, icons.Checkmark, icons.Globe, theme.icon, theme.iconSuccessFill, translate],
    );
