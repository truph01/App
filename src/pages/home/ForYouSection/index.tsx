...
import todosReportCountsSelector, {todosSingleReportIDsSelector} from '@src/selectors/Todos';
...
function ForYouSection() {
    ...
    const [singleReportIDs] = useOnyx(ONYXKEYS.DERIVED.TODOS, {canBeMissing: true, selector: todosSingleReportIDsSelector});
    ...
    const createNavigationHandler = (action: string, queryParams: Record<string, unknown>, reportID?: string) => () => {
        if (reportID) {
