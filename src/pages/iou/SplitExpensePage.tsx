...
function SplitExpensePage({route}: SplitExpensePageProps) {
    ...
    let warningMessage = '';
    if (difference < 0) {
        warningMessage = translate('iou.totalAmountLessThanOriginal', convertToDisplayString(-difference, transactionDetails.currency));
    } else if (difference > 0) {
        warningMessage = translate('iou.totalAmountGreaterThanOriginal', convertToDisplayString(difference, transactionDetails?.currency));
    }
