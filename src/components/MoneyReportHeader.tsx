...
function MoneyReportHeader({
    ...
    const confirmApproval = () => {
        ...
        if (isDelegateAccessRestricted) {
            ...
            approveMoneyRequest(moneyRequestReport, policy, accountID, email ?? '', hasViolations, isASAPSubmitBetaEnabled, nextStep, betas, true, ownerBillingGraceEndPeriod);
        }
    };
    ...
    const onApprove = (isFullApproval: boolean) => {
        ...
        startApprovedAnimation();
        approveMoneyRequest(moneyRequestReport, policy, accountID, email ?? '', hasViolations, isASAPSubmitBetaEnabled, nextStep, betas, isFullApproval, ownerBillingGraceEndPeriod);
