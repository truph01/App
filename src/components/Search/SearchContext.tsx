...
function SearchContextProvider({children}: ChildrenProps) {
    ...
    const currentSimilarSearchHash = searchContextData.currentSimilarSearchHash;
    ...
    const setCurrentSearchHashAndKey = useCallback((searchHash: number, similarHash: number, searchKey: SearchKey | undefined) => {
        setSearchContextData((prevState) => {
            if (searchHash === prevState.currentSearchHash && similarHash === prevState.currentSimilarSearchHash && searchKey === prevState.currentSearchKey) {
                return prevState;
            }
            ...
            return {
                ...
                currentSimilarSearchHash: similarHash,
