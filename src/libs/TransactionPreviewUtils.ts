...
const getReviewNavigationRoute = (
    ...
    const comparisonResult = compareDuplicateTransactionFields(policyTags, transaction, duplicates, transactionReport, transaction?.transactionID, policyCategories);
