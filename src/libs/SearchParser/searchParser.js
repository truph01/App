...
function peg$parse(input, options) {
    ...
    var peg$f0 = function (filters) {
        return applyDefaults(filters);
    };
    var peg$f1 = function (head, tail) {
        const allFilters = [head, ...tail.map(([_, filter]) => filter)].filter(Boolean).filter((filter) => filter.right);
        ...
        const keywordFilter = buildFilter('eq', 'keyword', keywords.map((filter) => filter.right.replace(/^(['"])(.*)\1$/, '$2')).flat());
    ...
    var peg$f50 = function () {
        return expectingNestedQuote;
    };
    var peg$f51 = function (start, inner, end) {
        //handle no-breaking space
        return [...start, '"', ...inner, '"', ...end].join('');
    };
    var peg$f52 = function (start) {
        return '“';
    };
    var peg$f53 = function (start) {
        return '”';
    };
    var peg$f54 = function (start) {
        return '"';
    };
...
const peg$allowedStartRules = ['query'];
