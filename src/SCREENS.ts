...
const SCREENS = {
    ...
    WORKSPACE: {
        ...
        TRAVEL_MISSING_PERSONAL_DETAILS_ROOT: 'Travel_Missing_Personal_Details_Root',
        TRAVEL_MISSING_PERSONAL_DETAILS: 'Travel_Missing_Personal_Details',
        TRAVEL_MISSING_PERSONAL_DETAILS_CONFIRM_MAGIC_CODE: 'Travel_Missing_Personal_Details_Confirm_Magic_Code',
