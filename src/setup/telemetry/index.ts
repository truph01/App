...
import {browserProfilingIntegration, navigationIntegration, tracingIntegration, consoleLoggingIntegration} from '@libs/telemetry/integrations';
...
export default function (): void {
    ...
    const integrations = [navigationIntegration, tracingIntegration, browserProfilingIntegration, consoleLoggingIntegration].filter((integration) => !!integration);
