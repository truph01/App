...
const CONST = {
    ...
    TELEMETRY: {
        ...
        SPAN_SUBMIT_EXPENSE: 'ManualSubmitExpense',
        SPAN_NAVIGATE_AFTER_EXPENSE_CREATE: 'ManualNavigateAfterExpenseCreate',
        SPAN_EXPENSE_SERVER_RESPONSE: 'ManualExpenseServerResponse',
