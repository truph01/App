...
const submoduleData: SubmoduleExampleDataType[] = [
    ...
    },
    {
        ...
        input: [
            {commit: '1', subject: 'Merge pull request #100 from Expensify/someBranch', authorName: 'test@gmail.com', authorDate: '2024-01-01T00:00:00Z'},
            {commit: '2', subject: 'Some random commit message', authorName: 'test@gmail.com', authorDate: '2024-01-02T00:00:00Z'},
        ],
        expectedOutput: [],
    },
    {
        name: 'extracts version-based submodule update',
        input: [{commit: 'abc123', subject: 'Update Mobile-Expensify submodule version to 9.3.21-0', authorName: 'OSBotify', authorDate: '2024-01-01T00:00:00Z'}],
        expectedOutput: [{version: '9.3.21-0', date: '2024-01-01T00:00:00Z', commit: 'abc123'}],
    },
    {
        name: 'extracts hash-based submodule update',
        input: [{commit: 'def456', subject: 'Update Mobile-Expensify submodule to 9f18fca', authorName: 'OSBotify', authorDate: '2024-01-02T00:00:00Z'}],
    ...
    },
    {
        ...
        input: [
            {commit: '1', subject: 'Merge pull request #100 from Expensify/someBranch', authorName: 'test@gmail.com', authorDate: '2024-01-01T00:00:00Z'},
            {commit: 'abc123', subject: 'Update Mobile-Expensify submodule version to 9.3.21-0', authorName: 'OSBotify', authorDate: '2024-01-02T00:00:00Z'},
            {commit: '2', subject: 'Merge pull request #101 from Expensify/anotherBranch', authorName: 'test@gmail.com', authorDate: '2024-01-03T00:00:00Z'},
            {commit: 'def456', subject: 'Update Mobile-Expensify submodule to 9f18fca', authorName: 'OSBotify', authorDate: '2024-01-04T00:00:00Z'},
            {commit: '3', subject: 'Some random commit message', authorName: 'test@gmail.com', authorDate: '2024-01-05T00:00:00Z'},
        ],
        expectedOutput: [
