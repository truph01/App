...
export default {
    ...
    fingerprint: {
        // TODO: Remove FINGERPRINT_BUST before merging — forces native rebuild for testing
        env: ['USE_WEB_PROXY', 'PUSHER_DEV_SUFFIX', 'SECURE_NGROK_URL', 'NGROK_URL', 'USE_NGROK', 'FINGERPRINT_BUST'],
